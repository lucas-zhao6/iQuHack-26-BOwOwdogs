"""
Naive bucketed baseline for threshold prediction.
"""
...
class NaiveBucketThresholdModel:
    """Wrapper that returns only threshold predictions."""
    ...
    def predict(
        ...
        thresholds, _runtimes = self._base.predict(X, feature_names=feature_names)
        return thresholds

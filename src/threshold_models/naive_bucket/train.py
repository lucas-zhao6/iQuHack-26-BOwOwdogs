#!/usr/bin/env python3
"""Train NaiveBucketThresholdModel folds using fixed CV splits."""
...
from src.threshold_models.naive_bucket.model import NaiveBucketThresholdModel

OUTPUT_DIR = PROJECT_ROOT / "outputs"
FEATURES_PATH = OUTPUT_DIR / "training_features.pkl"
CV_SPLITS_PATH = OUTPUT_DIR / "cv_splits.json"
MODEL_DIR = OUTPUT_DIR / "threshold_models" / "threshold_naive"
...
def main() -> None:
    ...
    for fold, split in enumerate(splits):
        ...
        model = NaiveBucketThresholdModel()
    ...
    full_model = NaiveBucketThresholdModel()

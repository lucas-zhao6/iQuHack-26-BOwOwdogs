#!/usr/bin/env python3
"""Train NaiveBucketRuntimeModel folds using fixed CV splits."""
...
from src.runtime_models.naive_bucket.model import NaiveBucketRuntimeModel

OUTPUT_DIR = PROJECT_ROOT / "outputs"
FEATURES_PATH = OUTPUT_DIR / "training_features.pkl"
CV_SPLITS_PATH = OUTPUT_DIR / "cv_splits.json"
MODEL_DIR = OUTPUT_DIR / "runtime_models" / "runtime_naive"
...
def main() -> None:
    ...
    full_model = NaiveBucketRuntimeModel()
